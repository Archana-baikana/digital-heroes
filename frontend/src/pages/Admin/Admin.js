...
const createDraw = async () => {
  try {
    ...
    const response = await fetch(
      'http://localhost:3001/api/draws/create',
      {
        method: 'POST',
        headers: {
...
const simulateDraw = async () => {
  try {
    ...
    const response = await fetch(
      'http://localhost:3001/api/draws/simulate',
      {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
...
const runDraw = async () => {
  ...
  try {
    ...
    const response = await fetch(
      'http://localhost:3001/api/draws/run',
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
...
const publishDraw = async () => {
  ...
  try {
    ...
    const response = await fetch(
      `http://localhost:3001/api/draws/${drawId}/publish`,
      {
        method: 'PUT',
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  const fetchAdminData = async () => {
    try {
      ...
      const winnersResponse = await fetch(
        'http://localhost:3001/api/admin/winners',
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      if (winnersResponse.ok) {
        ...
        setMessage(winnersData.message)
      }
    } catch (error) {
  ...
  const updateWinner = async (id, action) => {
    try {
      ...
      const response = await fetch(
        `http://localhost:3001/api/admin/winners/${id}/${action}`,
        {
          method: 'PUT',
          headers: {
            Authorization: `Bearer ${token}`,
